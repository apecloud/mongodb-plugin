...
func (s *mockEnginePluginServer) GetPluginInfo(ctx context.Context, in *plugin.GetPluginInfoRequest) (*plugin.GetPluginInfoResponse, error) {
...
func TestServe(t *testing.T) {
	...
	client := plugin.NewEnginePluginClient(conn)

	// Call a gRPC method on the server
	_, err = client.GetPluginInfo(context.Background(), &plugin.GetPluginInfoRequest{})
	if err != nil {
		t.Fatal(err)
	}
